...
class NB_classifier():
    ...
    def count_words(self):
        ...
        self.no_df[1].str.lower().str.split().apply(self.no_counter.update)
        self.words_in_no = sum(self.no_counter.values())
        self.yes_counter = Counter()
        self.yes_df[1].str.lower().str.split().apply(self.yes_counter.update)
    ...
    def create_probabilities_dict(self):
        """Create a dictionary with vocabulary words as keys and probabilities for yes/no as values"""
    ...
    def find_probability(self, word, label):
        """Find probability of a word given a label (i.e. class)"""
        if label == "no":
    ...
    def find_no_score(self, tweet):
        """Determine the score for the 'no' class"""
    ...
    def find_yes_score(self, tweet):
        """Determine the score for the 'yes' class"""
        words_list = tweet.split()
    ...
    def find_best_score(self, tweet, true_class):
        """Determine best score out of yes/no scores for a tweet"""
    ...
    def is_correct(self, prediction, true_class):
        """Determine if predicted class is correct or not"""
    ...
    def get_accuracy(self):
        ...
        print("THE TOTAL NUMBER OF VALUES IS ", number_of_instances)
